...
class HardwareDetailsPage extends JPanel {
    private ShoppingCart cart; // Reference to the shared ShoppingCart instance

    public HardwareDetailsPage(String name, String price, String imagePath, List<String> specifications, CardLayout cardLayout, JPanel mainPanel, ShoppingCart cart) {
        ...
        backButton.addActionListener(e -> cardLayout.show(mainPanel, "BuyHardware"));

        // Main content section
        JPanel contentPanel = new JPanel(new BorderLayout());
        contentPanel.setBackground(Color.WHITE);

        // Left: Enlarged Image of the hardware
        ...
        // Center and Right: Combined hardware details and specifications
        ...
        addToCartButton.addActionListener(e -> {
            try {
                double itemPrice = Double.parseDouble(price.replace("RM", "").replace(",", "").trim());
